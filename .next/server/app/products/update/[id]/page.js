...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.t.bind(__webpack_require__, 2923, 23)), "/Users/mg/Adrian/Coding/Belajar-NextJS/fullstack-nextjs/app/products/update/[id]/page.jsx"],
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 2335)), "/Users/mg/Adrian/Coding/Belajar-NextJS/fullstack-nextjs/app/layout.js"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4756))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/mg/Adrian/Coding/Belajar-NextJS/fullstack-nextjs/app/products/update/[id]/page.jsx"];
    ...
    const originalPathname = "/products/update/[id]/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 467))
...
/* harmony import */ var swr__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8149);
...
const UpdateProduct = ({ params  })=>{
    ...
    const [chooseBrand, setChooseBrand] = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)("");
    // > ambil id dari params
    const { id  } = params;
    // console.info(id, '=> ini id dari params');
    // > inisialisasi package useRoute
    const router = (0,next_navigation__WEBPACK_IMPORTED_MODULE_3__.useRouter)();
    const { data , error  } = (0,swr__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)(`/api/products/${id}`, fetcher);
    ...
    const handleUpdateProduct = async (event)=>{
        ...
        // > Update Data Product
        await axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"].patch */ .Z.patch(`/api/products/${id}`, updateData);
        // > Direct ke /products
...
module.exports = createProxy("/Users/mg/Adrian/Coding/Belajar-NextJS/fullstack-nextjs/app/products/update/[id]/page.jsx");
...
var __webpack_exports__ = __webpack_require__.X(0, [859,332,813,149,319], () => (__webpack_exec__(891)));
